    ...
    <div id="home-slider" class="carousel slide carousel-fade" data-ride="carousel">
        <div class="carousel-inner">
            <div class="item active" style="background-image: url(resources/images/slider/1.jpg)">
                <div class="caption">
                    <h1 class="animated fadeInLeftBig">Welcome to <span>Voting booth</span></h1>
                    <p class="animated fadeInRightBig">RPJS RPJS RPJS RPJS</p>
                    <a data-scroll class="btn btn-start animated fadeInUpBig" href="#services">Start now</a>
                </div>
            </div>
            <div class="item" style="background-image: url(resources/images/slider/2.jpg)">
                <div class="caption">
                    <h1 class="animated fadeInLeftBig">Say Hello to <span>Voting booth</span></h1>
                    <p class="animated fadeInRightBig">BRPJS RPJS RPJS RPJS</p>
                    <a data-scroll class="btn btn-start animated fadeInUpBig" href="#services">Start now</a>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="scroll"><a href="admin">sign in</a></li>
                    </ul>
                </div>
            </div>
        </div><!--/#main-nav-->
...
<section id="contact">
    <div id="google-map" class="wow fadeIn" data-latitude="50.067120" data-longitude="19.917002" data-wow-duration="1000ms" data-wow-delay="400ms"></div>
                    ...
                    <div class="col-sm-6">
                        <div class="contact-info wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                            ...
                            <ul class="address">
                                ...
                                <li><i class="fa fa-envelope"></i> <span> Email:</span><a href="mailto:kamil.regoc@gmail.com"> Kamil Rega</a></li>
